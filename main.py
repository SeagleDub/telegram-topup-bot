...
API_TOKEN = ""7829191204:AAF3utRWorh8gVGp-JbLngiZlaog4F6gf7k""  # ← замени
ADMIN_ID = 582761505           # ← замени
...
async def type_selected(query: types.CallbackQuery, state: FSMContext):
    ...
    topup_type = ""⚡ Срочное"" if data.get(""topup_type"") == ""urgent"" else ""🕘 Не срочное (до 21:00)""
...
# 💥 Обработка ""❌ Отмена"" на любом этапе
